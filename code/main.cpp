...
int main(void) {
    ...
    r2d2::gas_detection::gas_s gas_s_lpg = {static_cast<int>(r2d2::gas_detection::gas_type::LPG), 0};
    r2d2::gas_detection::gas_s gas_s_co = {static_cast<int>(r2d2::gas_detection::gas_type::CO), 0};
    r2d2::gas_detection::gas_s gas_s_smoke = {static_cast<int>(r2d2::gas_detection::gas_type::SMOKE), 0};

    //Create MQ-2 sensor object with corresponding gas curves.
    std::array<r2d2::gas_detection::mq_sensors_gas_curve_c, gasses_amount> mq_2_gas_curves = {lpg, co, smoke};

    //Create array with gas structs with variable amount.
    std::array<r2d2::gas_detection::gas_s, gasses_amount> gasses_s = {gas_s_lpg, gas_s_co, gas_s_smoke};

    //Create container with gas structs.
    r2d2::gas_detection::gas_container_c<gasses_amount> container_gasses(gasses_s);
    ...
    r2d2::gas_detection::gas_sensors_c<sensors_amount, gasses_amount> gas_sensors(comm1, gas_sensors_ptrs, container_gasses);
