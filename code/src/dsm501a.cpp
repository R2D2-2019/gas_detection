...
int dsm501a_c::read(){
    ...
    // floats are not accepted, so the real value *100
    int lowratio_round2 = ((duration_low_ms*100.0)/sampletime_ms)*100; // floats are not accepted, so the real value *100
