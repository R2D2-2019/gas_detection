...
int dsm501a_c::read(){
    ...
    int concentration_ugm3= ((0.001915 * (lowratio_round2/100.0 * lowratio_round2/100.0)) + (0.09522 * lowratio_round2/100.0) - 0.04884)*1000;   // https://forum.mysensors.org/topic/9497/dust-sensor-samyoung-dsm501a/7
    hwlib::cout << "duration_low_ms: " << duration_low_ms << " lowratio: " << lowratio_round2 << "    concentration_ugm3: " << concentration_ugm3 << "\n";
