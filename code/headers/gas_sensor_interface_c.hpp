...
namespace r2d2::gas_detection {
    ...
    /**
     * Class gas_sensor_interface_base_c is needed to create an array of
     * gas_sensor_interface_c instances. We cant do this directly because
     * gas_sensor_interface_c is an templated class.
     */
